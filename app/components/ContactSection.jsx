    ...
    const updateStatus = (newStatus) => {
      ...
      return (
        <section id="contact" className="px-4 py-16 bg-secondary bg-opacity-20">
            ...
            {status.type && <div className={`${status.type === "success" ? " bg-green-500" : " bg-red-500"} text-[#F5F5F5] rounded mt-7 p-5 mb-10 text-center`}><p dangerouslySetInnerHTML={{ __html: status.key}}/></div>}
