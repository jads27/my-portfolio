        ...
        <section id="projects" className="mx-auto max-w-6xl px-4 py-16">
            ...
            <div className="flex items-center flex-col gap-11 md:mx-28">
                ...
                <Project image="bg-bar-lullaby-paris" name="Sophie Bluel" title={currentTranslations.projects.modal.sophieBluelPortfolioWebsite.title} onClick={() => handleOpen({ 
                    ...
                    details: `<span>${currentTranslations.projects.modal.sophieBluelPortfolioWebsite.description.part1}</span><span>${currentTranslations.projects.modal.sophieBluelPortfolioWebsite.description.part2}</span><span>${currentTranslations.projects.modal.sophieBluelPortfolioWebsite.description.part3}</span>`, 
