...
export default function ProjectsSection() {
    ...
    return (
        <section id="projects" className="mx-auto max-w-6xl px-4 py-16">
            <span className="self-start text-xl font-roboto-mono font-bold text-accent">03.</span>
            <div className="flex items-center flex-col gap-11 md:mx-28">
                ...
                <Project image="bg-accommodation" name="Kasa" title={currentTranslations.projects.modal.sophieBluelPortfolioWebsite.title} onClick={() => handleOpen({ 
                    ...
                    details: `<span>${currentTranslations.projects.modal.kasaWebsite.description.part1}</span><span>${currentTranslations.projects.modal.kasaWebsite.description.part2}</span><span>${currentTranslations.projects.modal.kasaWebsite.description.part3}</span>`, 
                    ...
                    redirectButton: `<a class="flex justify-center items-center w-1/2 text-secondary py-3 font-bold rounded border-2 border-secondary md:py-6" href="https://github.com/jads27/kasa" target="_blank" rel="noopener noreferrer">${currentTranslations.projects.modal.viewCode}</a><a class="flex justify-center items-center w-1/2 text-[#F5F5F5] bg-primary py-3 rounded md:py-6" href="https://kasa-88t8tqamy-jimmys-projects-659bc9ff.vercel.app/" target="_blank" rel="noopener noreferrer">${currentTranslations.projects.modal.visitWebsite}</a>`
                    })} />
                <Project image="bg-annie-spratt" name="Booki" title={currentTranslations.projects.modal.sophieBluelPortfolioWebsite.title} onClick={() => handleOpen({ 
                    imagePreview: "/booki-page.svg", 
                    alt: "Preview of the Booki website", 
                    title: currentTranslations.projects.modal.bookiWebsite.title, 
                    details: `<span>${currentTranslations.projects.modal.bookiWebsite.description.part1}</span><span>${currentTranslations.projects.modal.bookiWebsite.description.part2}</span>`, 
                ...
                <Project image="bg-bar-lullaby-paris" name="Sophie Bluel" title={currentTranslations.projects.modal.sophieBluelPortfolioWebsite.title} onClick={() => handleOpen({ 
